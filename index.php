...
<body>
    ...
    <!-- Modal LISTAR FILAS -->
    <div class="modal fade" id="modalListar" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" id="listAccessForm" class="needs-validation box" novalidate name="form">
                    <div class="modal-header">
                        <img src="./assets/img/Screenshot_1.png" alt="">
                    </div>
                    <div class="modal-body">
    ...
    <footer class="footer_index">
        <ul class="list_index">
            ...
            <li>
                <a href="#" id="openListar" type="submit">Minhas Filas</a>
            </li>
            <li>
