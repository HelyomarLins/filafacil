...
if ($_SESSION["logged_in"]) {
    ...
    $sql = "SELECT fc.*, cf.nome_fila 
            ...
            WHERE fc.pessoa_idUsu = '$idCampo' AND fc.atendido = 'não'";
            ...
            <tbody>
                ...
                if (mysqli_num_rows($resultado) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo "<td>";
                        echo "<a href='#' class='edit' data-id='"  . $row["id_fila_chamada"] . "' onclick=\"loadContent('/Fila_Facil/system/usuario/accessFilaUsu.php?id_criar_fila=" . $row["id_fila_chamada"] . "')\">";
